...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8080", "http://frontend:3000", "http://localhost:3000", "https://localhost:443", "https://localhost:8443"], #TODO: Change this settings.BACKEND_CORS_ORIGINS from env file
